...
programación funcional. Puedes consultar nuestra introducción a Haskell con recursos para 
...
También puedes consultar nuestros apuntes de introducción a teoría de categorías.
...
Para entender cómo funcionan las mónadas en teoría de categorías tenemos que entender dos
conceptos: los *productos en una categoría monoidal* y *los endofuntores de una categoría*.
La unión de ambos conceptos es lo que nos dará las mónadas como una construcción en teoría
de categorías.
