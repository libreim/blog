...
### Mónadas en Haskell
Empezamos explicando la motivación de las mónadas dentro de la
programación funcional. Imaginemos que necesitamos controlar cuando
una función interna devuelve un error, o cambia un estado que debe ser
pasado al resto de funciones. Una solución sería modificar cada una de
las funciones que usamos para que tenga en cuenta ese estado, pero
esto añadiría mucha complejidad innecesaria a nuestro código.
