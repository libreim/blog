...
Bueno, el temario de las asignaturas que vas a cursar es el necesario para
aprobarlas. Podrías pasar todo este texto por alto y seguir sacando buena nota.
Pero creemos que todo lo que te vamos a contar a continuación va dirigido a que
puedas organizar mejor tu trabajo, ahorrar mucho tiempo y evitarte pequeños
desastres.

Además, la mayoría de las herramientas que destacamos seguro que
acabarás teniendo que usarlas en algún momento, así que mejor que cojas algo de
práctica antes.

Por último, esto probablemente no sea suficiente. Durante la carrera habrá
momentos en los que tendrás que buscarte la vida y encontrar otras formas de
...
No es un proceso fácil aprender LaTeX, pero te acabará siendo rentable.

## Puffff, LaTeX es complicadísimo.

Tenemos una alternativa. **Markdown** es otro lenguaje de marcado, diseñado por
*John Gruber* y *Aaron Swartz*, mucho más simple. Con **pandoc** podrás 
transformar a pdf documentos con fórmulas de LaTeX.

De hecho, este mismo post que estás leyendo (y todo el foro) está escrito en Markdown.
...
No subestimes los buscadores de internet, **Google** o **DuckDuckGo**. La mayoría
...
considerarlos siquiera un problema. Probablemente también conozcas
[**Wolfram Alpha**](http://www.wolframalpha.com/), buscador de respuestas para
matemáticas y el sitio al que acudir cuando no te sale una integral.
...
particionar tu disco duro e instalarlo junto al sistema operativo que ahora uses;
...
* **Instala Linux.** Elige una distribución y prepárate para el proceso completo.
  Ten especial cuidado si quieres particionar el disco.
