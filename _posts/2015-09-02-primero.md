...
* [**GPL.**](http://www.gnu.org/licenses/gpl-3.0.en.html) Asegura las libertades de la FSF. Además, si otro programa usa fragmentos
  de código en GPL, debe licenciarse completamente en GPL.
* [**Creative Commons.**](http://es.creativecommons.org/blog/licencias/) No son específicas para el código. Los posts de este blog
...
La [**Oficina de Software Libre**](http://osl.ugr.es) tiene su dirección en el número 36-38 de la
c/Real de Cartuja, compartiendo oficinas con el CEVUG. Se encarga de propagar
