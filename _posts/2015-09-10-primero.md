...
[**foro** de matemáticas e informática](http://tux.ugr.es/dgiim/overflow/).
...
enteras de las matemáticas o la informática. En nuestra [página de recursos](/dgiim/awesome/) hay varias
...
Y si quieres algo más concreto, pregunta en el [foro](/dgiim/overflow/). Entre todos llevamos la cuenta
...
Entre los [recursos](/dgiim/awesome/) de esta página tienes libros y apuntes con sus correspondientes
ejercicios.
...
informática, empezamos este mismo [blog](http://tux.ugr.es/dgiim/blog/) que estás leyendo, un [foro](http://tux.ugr.es/dgiim/overflow/) donde
