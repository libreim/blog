...
verlo [aquí](https://raw.githubusercontent.com/dgiim/blog/gh-pages/_posts/2015-09-10-primero.md).
...
el libro en sí se escribió completamente [en LaTeX](https://github.com/dgiim/calculo).
...
a la carrera, empezamos este mismo [blog](http://tux.ugr.es/dgiim/blog/) que estás leyendo, un [foro](http://dgiim.github.io/foro/) donde
compartir dudas y una [organización de GitHub](https://github.com/dgiim) con repositorios para proyectos
