...
* Un [manual rápido de Git/GitHub](http://tux.ugr.es/dgiim/blog/2014/02/23/manualgit/), escrito por David Charte en este mismo blog.
...
* [¿Cómo aprender LaTeX?](http://tux.ugr.es/dgiim/blog/2015/03/14/latex/), un compendio de recursos.
* [Introducción a Beamer](http://tux.ugr.es/dgiim/blog/2015/03/14/intro-beamer/), una guía de beamer escrita en beamer.
...
verlo [aquí](https://raw.githubusercontent.com/libreim/blog/gh-pages/_posts/2015-09-10-primero.md).
...
[**foro** de matemáticas e informática](http://tux.ugr.es/dgiimoverflow/).
...
Charte](http://blog.fdavidcl.me/post/105862529162/mi-escritorio-minimalista) para Gnome Ubuntu.
...
Y si quieres algo más concreto, pregunta en el [foro](http://libreim.github.io/foro/). Entre todos llevamos la cuenta
...
Entre los [recursos](http://libreim.github.io/awesome/) de esta página tienes libros y apuntes con sus correspondientes
ejercicios.
...
informática, empezamos este mismo [blog](http://tux.ugr.es/dgiim/blog/) que estás leyendo, un [foro](http://tux.ugr.es/dgiimoverflow/) donde
